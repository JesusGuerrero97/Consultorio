        ...
        <div class="row mrg2">
            ...
            <div class="input-field col m3">
                ...
                <form name="frmUsuario" id="frmUsuario">
                    <div id="idModal" class="modal modal-fixed-footer customodal">
                        <div class="modal-content">
                        	<h4 class="black-text center">Empleados</h4>
		                    <div class="row">
							    <form class="col s12">
							      <div class="row">
            ...
            <script type="text/javascript">
				...
				app.controller('crtl',function($scope, $http, $filter)
				{
					...
					$scope.modificar=function()
					{
						...
						{
							$http.post('/modificarEmpleados/'+$scope.id, $scope.empleadomodificar).then
							(
								function(response)
								{
